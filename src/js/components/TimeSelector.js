...
define((['Sheet', 'commonLogic']),function(Sheet, _) {
	...
	function TimeSelector(opt) {
		...
		this.openTime = opt.openTime || '11:00';    	// 门店每日开始营业时间
		this.closeTime = opt.closeTime || '00:00';	// 门店每日开始营业时间
	...
	function bind($el, length, handleScrollTo) {
		...
		var maxOffset = (0 - itemHeight) * (length - 2);
		...
		var endHandler = function(e){
			...
			var index = Math.round(1 - offsetY / itemHeight);
